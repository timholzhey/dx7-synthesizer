...
static uint64_t *buffer_64 = (uint64_t *) buffer_8;
...
static void write_hex_bytes_to_file(uint8_t *p_data, uint32_t num_elements, uint32_t element_size, const char *filename) {
	...
	// write data
	uint32_t num_bytes = num_elements * element_size;
	for (uint32_t i = 0; i < num_bytes; i += element_size) {
		switch (element_size) {
			case 1:
			...
			case 4:
				...
				break;
			case 8:
				fprintf(file, "%02x%02x%02x%02x%02x%02x%02x%02x", p_data[i + 7], p_data[i + 6], p_data[i + 5], p_data[i + 4], p_data[i + 3], p_data[i + 2], p_data[i + 1], p_data[i]);
				break;
			default:
...
int main(void) {
	...
	uint8_t algorithm_routing_table[ALGORITHM_ROUTING_TABLE_SIZE][NUM_OPERATORS] = {
			...
			[11] = {OUTPUT_MOD_INDEX_MASTER, OUTPUT_MODE_INDEX_1, OUTPUT_MOD_INDEX_MASTER, OUTPUT_MODE_INDEX_3, OUTPUT_MODE_INDEX_3, OUTPUT_MODE_INDEX_3 | OUTPUT_MODE_INDEX_6},
			[12] = {OUTPUT_MOD_INDEX_MASTER, OUTPUT_MODE_INDEX_1, OUTPUT_MOD_INDEX_MASTER, OUTPUT_MODE_INDEX_3, OUTPUT_MODE_INDEX_4, OUTPUT_MODE_INDEX_4 | OUTPUT_MODE_INDEX_6},
			[13] = {OUTPUT_MOD_INDEX_MASTER, OUTPUT_MODE_INDEX_1 | OUTPUT_MODE_INDEX_2, OUTPUT_MOD_INDEX_MASTER, OUTPUT_MODE_INDEX_3, OUTPUT_MODE_INDEX_4, OUTPUT_MODE_INDEX_4},
			[14] = {OUTPUT_MOD_INDEX_MASTER, OUTPUT_MODE_INDEX_1, OUTPUT_MODE_INDEX_1, OUTPUT_MODE_INDEX_3, OUTPUT_MODE_INDEX_1, OUTPUT_MODE_INDEX_5 | OUTPUT_MODE_INDEX_6},
			[15] = {OUTPUT_MOD_INDEX_MASTER, OUTPUT_MODE_INDEX_1, OUTPUT_MODE_INDEX_2, OUTPUT_MODE_INDEX_1, OUTPUT_MODE_INDEX_4, OUTPUT_MODE_INDEX_1 | OUTPUT_MODE_INDEX_6},
			[16] = {OUTPUT_MOD_INDEX_MASTER, OUTPUT_MODE_INDEX_1, OUTPUT_MODE_INDEX_2, OUTPUT_MOD_INDEX_MASTER, OUTPUT_MOD_INDEX_MASTER, OUTPUT_MODE_INDEX_4 | OUTPUT_MODE_INDEX_5 | OUTPUT_MODE_INDEX_6},
			[17] = {OUTPUT_MOD_INDEX_MASTER, OUTPUT_MODE_INDEX_1, OUTPUT_MODE_INDEX_1 | OUTPUT_MODE_INDEX_3, OUTPUT_MODE_INDEX_1, OUTPUT_MODE_INDEX_4, OUTPUT_MODE_INDEX_5},
			[18] = {OUTPUT_MOD_INDEX_MASTER, OUTPUT_MOD_INDEX_MASTER, OUTPUT_MODE_INDEX_1 | OUTPUT_MODE_INDEX_2 | OUTPUT_MODE_INDEX_3, OUTPUT_MOD_INDEX_MASTER, OUTPUT_MOD_INDEX_MASTER, OUTPUT_MODE_INDEX_4 | OUTPUT_MODE_INDEX_5},
			[19] = {OUTPUT_MOD_INDEX_MASTER, OUTPUT_MOD_INDEX_MASTER, OUTPUT_MODE_INDEX_1 | OUTPUT_MODE_INDEX_2 | OUTPUT_MODE_INDEX_3, OUTPUT_MOD_INDEX_MASTER, OUTPUT_MODE_INDEX_4, OUTPUT_MODE_INDEX_4},
			[20] = {OUTPUT_MOD_INDEX_MASTER, OUTPUT_MODE_INDEX_1, OUTPUT_MOD_INDEX_MASTER, OUTPUT_MOD_INDEX_MASTER, OUTPUT_MOD_INDEX_MASTER, OUTPUT_MODE_INDEX_3 | OUTPUT_MODE_INDEX_4 | OUTPUT_MODE_INDEX_5 | OUTPUT_MODE_INDEX_6},
			[21] = {OUTPUT_MOD_INDEX_MASTER, OUTPUT_MOD_INDEX_MASTER, OUTPUT_MOD_INDEX_MASTER, OUTPUT_MOD_INDEX_MASTER, OUTPUT_MOD_INDEX_MASTER, OUTPUT_MODE_INDEX_4 | OUTPUT_MODE_INDEX_5 | OUTPUT_MODE_INDEX_6},
			[22] = {OUTPUT_MOD_INDEX_MASTER, OUTPUT_MOD_INDEX_MASTER, OUTPUT_MODE_INDEX_2, OUTPUT_MOD_INDEX_MASTER, OUTPUT_MOD_INDEX_MASTER, OUTPUT_MODE_INDEX_4 | OUTPUT_MODE_INDEX_5 | OUTPUT_MODE_INDEX_6},
			[23] = {OUTPUT_MOD_INDEX_MASTER, OUTPUT_MOD_INDEX_MASTER, OUTPUT_MOD_INDEX_MASTER, OUTPUT_MOD_INDEX_MASTER, OUTPUT_MOD_INDEX_MASTER, OUTPUT_MODE_INDEX_3 | OUTPUT_MODE_INDEX_4 | OUTPUT_MODE_INDEX_5 | OUTPUT_MODE_INDEX_6},
			[24] = {OUTPUT_MOD_INDEX_MASTER, OUTPUT_MODE_INDEX_1, OUTPUT_MOD_INDEX_MASTER, OUTPUT_MODE_INDEX_3, OUTPUT_MODE_INDEX_4 | OUTPUT_MODE_INDEX_5, OUTPUT_MOD_INDEX_MASTER},
			[25] = {OUTPUT_MOD_INDEX_MASTER, OUTPUT_MOD_INDEX_MASTER, OUTPUT_MOD_INDEX_MASTER, OUTPUT_MODE_INDEX_3, OUTPUT_MOD_INDEX_MASTER, OUTPUT_MODE_INDEX_5 | OUTPUT_MODE_INDEX_6},
			[26] = {OUTPUT_MOD_INDEX_MASTER, OUTPUT_MOD_INDEX_MASTER, OUTPUT_MOD_INDEX_MASTER, OUTPUT_MODE_INDEX_3, OUTPUT_MODE_INDEX_4 | OUTPUT_MODE_INDEX_5, OUTPUT_MOD_INDEX_MASTER},
			[27] = {OUTPUT_MOD_INDEX_MASTER, OUTPUT_MOD_INDEX_MASTER, OUTPUT_MODE_INDEX_2 | OUTPUT_MODE_INDEX_3, OUTPUT_MOD_INDEX_MASTER, OUTPUT_MODE_INDEX_4, OUTPUT_MODE_INDEX_4},
			[28] = {OUTPUT_MOD_INDEX_MASTER, OUTPUT_MOD_INDEX_MASTER, OUTPUT_MODE_INDEX_2, OUTPUT_MOD_INDEX_MASTER, OUTPUT_MODE_INDEX_4, OUTPUT_MODE_INDEX_4 | OUTPUT_MODE_INDEX_6},
			[29] = {OUTPUT_MOD_INDEX_MASTER, OUTPUT_MOD_INDEX_MASTER, OUTPUT_MOD_INDEX_MASTER, OUTPUT_MOD_INDEX_MASTER, OUTPUT_MOD_INDEX_MASTER, OUTPUT_MODE_INDEX_5 | OUTPUT_MODE_INDEX_6},
			[30] = {OUTPUT_MOD_INDEX_MASTER, OUTPUT_MOD_INDEX_MASTER, OUTPUT_MOD_INDEX_MASTER, OUTPUT_MOD_INDEX_MASTER, OUTPUT_MOD_INDEX_MASTER, OUTPUT_MOD_INDEX_MASTER | OUTPUT_MODE_INDEX_6}
	};
	// write 64 bit hex values to buffer
	for (uint32_t i = 0; i < ALGORITHM_ROUTING_TABLE_SIZE; i++) {
		uint64_t algorithm;
		memcpy(&algorithm, &algorithm_routing_table[i], sizeof(uint64_t));
		buffer_64[i] = algorithm & 0xFFFFFFFFFFFF;
	}
	write_hex_bytes_to_file(buffer_8, ALGORITHM_ROUTING_TABLE_SIZE, 8, "hex_u64_algorithm_routing.mem");
